/*
Diabase Engineering Rotary Printing Wizard fileProcessing.cc
By Nick Colleran and Richard Warner

This code was written for Diabase Engineering.
It uses c++ code and the stl_reader written by Sebastian Reiter in 2018 to create a NodeJS plugin used to process STL files. 
All code used is done so with permission.

This wizard can modify stlfiles to prepare them for rotary printing on a Diabase Engineering Machine.
*/
