...
// Root
const rotaryButtonRow = [rotaryBackButton, websiteButton,
  continueToStlProcessing, rotaryGcodeButton];
...
const stlToGcode = guiTools.createButton('buttonRowButton', 'Continue to\nGcode processing');
